...
@app.callback(Output(component_id="result",component_property="children"),
              [Input(component_id="Anime_Title",component_property="value"),
               Input(component_id="Anime_Genre(s)",component_property="value"),
               Input(component_id="Anime_Description",component_property="value"),
               Input(component_id="Anime_Type",component_property="value"),
               Input(component_id="Anime_Producer",component_property="value"),
               Input(component_id="Anime_Studio",component_property="value")
    ])
def display_result(Anime_Title,Anime_Genre,Anime_Description,Anime_Type,Anime_Producer,Anime_Studio):
